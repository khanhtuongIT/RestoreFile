...
namespace KickassUndelete {
	...
	public class ListViewColumnSorter : IComparer {
		...
		public int Compare(object x, object y) {
            ...
            //    //compareResult = _objectCompare.Compare(Convert.ToString(((INodeMetadata)listviewX.Tag).ChanceOfRecovery), Convert.ToString(((INodeMetadata)listviewY.Tag).ChanceOfRecovery));
            //    compareResult = _objectCompare.Compare(listviewX.SubItems[_columnToSort].Text, listviewX.SubItems[_columnToSort].Text);
            //}
            else {
