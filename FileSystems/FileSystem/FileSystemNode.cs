...
namespace KFS.FileSystems {
	...
	public abstract class FileSystemNode : IFileSystemNode {
        ...
        public abstract DateTime LastAccessed { get; }
        ...
        private FileRecoveryStatus _recoveryStatus = FileRecoveryStatus.Overwritten;
		public FileRecoveryStatus ChanceOfRecovery {
			get {
				if (_recoveryStatus == FileRecoveryStatus.Overwritten) {
